      ...
      <div className="row">
        <div className="col-10 mx-auto">
          ...
          <p>
            ...
            find nearby places to pitch your tent, park your RV, or take in some
            local sites. And while it can certainly be helpful, the app also
          ...
          <p>
            ...
            members, you can edit the site if you notice that something is wrong
            or if you want to add additional information or photos, and you can
            also leave and read reviews from other users.
          </p>
          <p>
            A filter button lets you sort sites according to what you’re looking
            for and helps clear the clutter. You can for example, switch the
            toggles to include only free campgrounds that accept pets and have
            water facilities. You can see results either on the map or the list.
            One unfortunate thing is that the app seems to use Google Maps, so
            you wind up seeing all of the destinations that Google provides, but
            they aren’t all clickable so things can get a bit confusing.
          </p>
          <p>
            Like many apps, WikiCamps comes with a 14-day free trial. After
            that, it costs a one-time payment of $1.99 for lifetime access. The
